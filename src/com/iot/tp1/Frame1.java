...
public class Frame1 {
	...
	private void initialize() {
		...
		btnAutonomo.setBounds(85, 315, 108, 23);
		...
		JLabel lblRepeticao = new JLabel("Repetições");
		lblRepeticao.setFont(new Font("Times New Roman", Font.PLAIN, 11));
		lblRepeticao.setBounds(30, 284, 50, 14);
		frmLeitorDeRfid.getContentPane().add(lblRepeticao);

		textField_3 = new JTextField();
		textField_3.setColumns(10);
		textField_3.setBounds(85, 282, 54, 20);
		textField_3.setText("5");
		frmLeitorDeRfid.getContentPane().add(textField_3);
