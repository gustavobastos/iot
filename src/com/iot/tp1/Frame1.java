...
public class Frame1 {
	...
	private void initialize() {
		...
		separator.setBounds(10, 175, 273, 2);
		...
		textField_3.setBounds(85, 153, 38, 20);
		frmLeitorDeRfid.getContentPane().add(textField_3);
		textField_3.setColumns(10);
		
		JLabel lblRepeties = new JLabel("Repeti\u00E7\u00F5es");
		lblRepeties.setFont(new Font("DialogInput", Font.BOLD, 12));
		lblRepeties.setBounds(10, 155, 241, 14);
		frmLeitorDeRfid.getContentPane().add(lblRepeties);

		btnManual.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					new reader(textField_2.getText(), textField_3.getText());
